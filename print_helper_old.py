...
def generate_print_text(order_data, print_method):
    ...
    if zip_code or country_code:
        zip_country_line = f"{zip_code} {country_code}".strip()
        lines.append(zip_country_line)
